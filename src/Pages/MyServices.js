                ...
                <div class="card card-compact w-96 bg-base-100 shadow-xl">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-actions justify-end">
                            <Link to='#contact' smooth><button class="text-black btn bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500">Get this service</button></Link>
                        </div>
                    </div>
                </div>
                <div class="card card-compact w-96 bg-base-100 shadow-xl">
